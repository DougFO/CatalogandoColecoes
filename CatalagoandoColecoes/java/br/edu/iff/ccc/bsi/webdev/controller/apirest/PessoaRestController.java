...
public class PessoaRestController {
	...
	@PostMapping
	@Operation(summary = "Cadastrando dados de uma pessoa")
	@ApiResponses({
...
//	public ResponseEntity<Pessoa> remove(Pessoa pessoa, Usuario user, Endereco endereco) {
	public ResponseEntity<Pessoa> remove(@PathVariable("cpf") String cpf) {
		
//		return new ResponseEntity<>(pessoaService.remove(user, pessoa, endereco), HttpStatus.OK);
